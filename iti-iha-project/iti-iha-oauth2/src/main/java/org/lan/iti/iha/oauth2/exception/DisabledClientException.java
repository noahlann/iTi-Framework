 ...
 */
public class DisabledClientException extends AuthenticationException {
    private static final long serialVersionUID = 5505917675834143534L;

    public DisabledClientException() {
        super(ErrorEnum.DISABLED_CLIENT);
    }

    public DisabledClientException(String code, String message) {
        super(code, message);
    }
}
