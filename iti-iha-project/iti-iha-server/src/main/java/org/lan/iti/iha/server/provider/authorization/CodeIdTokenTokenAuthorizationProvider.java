 ...
 */
public class CodeIdTokenTokenAuthorizationProvider implements AuthorizationProvider {
    @Override
    ...
    public String generateRedirect(IhaServerRequestParam param, String responseType, ClientDetails clientDetails, UserDetails userDetails, String issuer) {
        ...
        AuthorizationProvider codeTokenProvider = ExtensionLoader.getLoader(AuthorizationProvider.class)
                .getFirst(ResponseType.CODE_TOKEN.getType());
        return codeTokenProvider.generateRedirect(param, responseType, clientDetails, userDetails, issuer) + params;
    }
}
