...
package org.lan.iti.codegen.repository.util;

import com.google.common.collect.Sets;
import lombok.experimental.UtilityClass;
import lombok.extern.slf4j.Slf4j;
import org.lan.iti.codegen.TypeCollector;
import org.lan.iti.codegen.repository.Index;
import org.lan.iti.codegen.repository.IndexMeta;
import org.lan.iti.codegen.repository.Indexes;
        ...
        for (Index index : indices) {
            ...
            for (String fieldName : index.value()) {
                ...
                if (variableElement != null) {
                    ...
                    log.error("failed to find field {}", fieldName);
                }
            }
