...
import org.lan.iti.cloud.iha.oauth2.GrantType;
...
import org.lan.iti.cloud.iha.server.exception.*;
...
public class OAuthUtil {
     ...
     * @return long
     */
    public static long getAccessTokenExpiresIn(Duration ttl) {
        return Optional.ofNullable(ttl).orElse(IhaServerConstants.ACCESS_TOKEN_ACTIVITY_TIME).getSeconds();
    }
     ...
     * @return long
     */
    public static long getRefreshTokenExpiresIn(Duration ttl) {
        return Optional.ofNullable(ttl).orElse(IhaServerConstants.REFRESH_TOKEN_ACTIVITY_TIME).getSeconds();
    }
     ...
     * @return long
     */
    public static long getCodeExpiresIn(Duration ttl) {
        return Optional.ofNullable(ttl).orElse(IhaServerConstants.AUTHORIZATION_CODE_ACTIVITY_TIME).getSeconds();
    }
     ...
     * @return long
     */
    public static long getIdTokenExpiresIn(Duration ttl) {
        return Optional.ofNullable(ttl).orElse(IhaServerConstants.ID_TOKEN_ACTIVITY_TIME).getSeconds();
    }
     ...
     * @return long
     */
    public static LocalDateTime getAccessTokenExpiresAt(Duration ttl) {
     ...
     * @return long
     */
    public static LocalDateTime getRefreshTokenExpiresAt(Duration ttl) {
     ...
     * @return long
     */
    public static LocalDateTime getCodeExpiresAt(Duration ttl) {
     ...
     * @return long
     */
    public static LocalDateTime getIdTokenExpiresAt(Duration ttl) {
