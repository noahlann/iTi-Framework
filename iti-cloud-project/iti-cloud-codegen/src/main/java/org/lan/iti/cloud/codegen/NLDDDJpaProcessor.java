...
import org.lan.iti.codegen.AbstractGeneratorProcessor;
...
public class NLDDDJpaProcessor extends AbstractGeneratorProcessor {
    public final ProcessorPlugin[] PLUGINS = ArrayUtil.append(NLDDDProcessor.PLUGINS,
