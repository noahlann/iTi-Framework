...
public interface ITIUserDetailsService extends UserDetailsService {
     ...
     *
     * @param principal  唯一标识 (userId, userName)
     * @param providerId 提供者ID
     * @param domain     域类型
     * @return 用户鉴权模型
     * @throws UsernameNotFoundException 未找到用户
     */
    ITIUserDetails loadUser(String principal, String providerId, String domain) throws UsernameNotFoundException;
     ...
     * @return 用户鉴权模型（粗略版）
     */
    ITIUserDetails register(String principal, String providerId, String domain, String credentials, Map<String, String> extra);
